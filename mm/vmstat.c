...
const char * const vmstat_text[] = {
	...
	"lmy_check_migrate_all",
	"lmy_no_memory_space",
	"lmy_hot_page",
	"lmy_unmap_promote_success",
	"lmy_pebs_promote",
	"lmy_demote_page",
	// exchange stat
	"lmy_exchange_page_all",
	"lmy_exchange_page_success",
	"lmy_exchange_page_fail",
	"lmy_exchange_page_fail_no_candidate_page",
#endif
#ifdef CONFIG_PAGE_GUPS_TEST
	"gups_predict_all",
	"gups_predict_hot",
	"gups_predict_not_in_area",
	"gups_promote_all",
	"gups_promote_hot",
	"gups_promote_not_in_area",
	"gups_demote_all", // not used, 因为demote部分没有现成的虚拟地址
	"gups_demote_hot", // not used
	"gups_demote_not_in_area", // not used
#endif
#ifdef CONFIG_NUMA
	"zone_reclaim_failed",
#endif
